...
body{
    background-image: url('http://getwallpapers.com/wallpaper/small-retina/2/1/4/1519214-orange-geometric-wallpaper-2560x1600-for-mobile.jpg');
...
<h3 align="center">welcome admin</h3>
	<form:form action="/ProjectTestShop/loginSuccess2" method="post" modelAttribute="adminCredential">
